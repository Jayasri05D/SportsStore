...
function Navbar({ onLoginClick, onCartClick, onFavoritesClick, onHomeClick, cartCount, favoritesCount,onProfileclick }) {
  return (
    <nav className="navbar">
      ...
      <div className="navbar-links">
        ...
        <a href="#profile" onClick={onProfileclick}>Profile</a>
